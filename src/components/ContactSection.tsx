...
const ContactSection = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'sandeshyesane996@gmail.com',
      href: 'mailto:sandeshyesane996@gmail.com',
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+91 9321451240',
      href: 'tel:+919321451240',
    },
    {
      icon: MapPin,
      label: 'Location',
  ...
  return (
    <section id="contact" className="py-24 relative" ref={ref}>
      {/* Background */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_hsl(187_100%_50%_/_0.05)_0%,_transparent_50%)]" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <div className="flex gap-4">
                {socials.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="p-4 rounded-xl glass text-muted-foreground hover:text-primary transition-colors"
                  >
                    <social.icon size={24} />
                  </motion.a>
                ))}
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 rounded-lg bg-primary text-primary-foreground font-semibold text-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity glow-sm"
            >
              <Send size={20} />
              Send Message
            </motion.button>
